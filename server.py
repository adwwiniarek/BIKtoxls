...
def process_bik_report():
    """
    Endpoint, który przyjmuje plik PDF, parsuje go i zwraca dane w formacie JSON.
    """
    ...
    try:
        ...
        logging.info(f"Parser zwrócił {len(parsed_data)} rekordów. Odsyłanie odpowiedzi JSON.")
        
        # Zwróć wynik jako JSON - to jest kluczowa zmiana przywracająca stabilność
...
# Ta sekcja nie jest używana przez Gunicorn na Render, służy do testów lokalnych
